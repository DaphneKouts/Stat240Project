...
This dataset is a randomly selected sample of passengers that were on board the titanic. This dataset contains 891 out of the total 1300 passengers on board. We will use this dataset to get a sample proportion of survivors. This isn't a full population dataset, which could be an unusual factor in our data, but because it is a random sample, it should be statistically sound.
...
>The parameters of interest are the proportions of female passengers and female suvivors of the Titanic. We are testing whether there is a greater proportion of female survivors than passengers

>This is a 1-tailed inference on a single sample proportion

> Our assumptions are that this follows a binomial distribution. There is a continuous rate, or a proportion of female survivors, the chance of each person surviving is independent from each other, there is a set number of people aboard the ship in this random sample, and a given survivor can either be male or female.
...
> Calculating the probability of the resulting number of female survivors or more surviving assuming that the probability of any given female surviving is equal to the proportion of females on the ship.
...
> Because we have a p-value extremely close to 0 and less than alpha, we can reject the null hypothesis that the proportions of female survivors is equal to the proportion of female passengers on the Titanic. In conclusion,
we have significant evidence to suggest that the proportion of women survivors is higher than the population proportion of women on board at the beginning of the trip. This correlates to the idea that depictions of the tragedy often portrayed the prioritization of women and children surviving.
